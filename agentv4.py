...
def find_closest_resources(pos, player, resource_tiles):
    ...
    for resource_tile in resource_tiles:
        ...
        if resource_tile.resource.type == Constants.RESOURCE_TYPES.COAL and (player.research_points < 43 ): continue

        if resource_tile.resource.type == Constants.RESOURCE_TYPES.URANIUM and (player.research_points < 170 ): continue
